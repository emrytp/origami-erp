  ...
  const steps = [
    {
      ...
      description:
        'İşletmenizin gereksinimlerini, mevcut sistemlerini ve operasyonel zorluklarını detaylı şekilde analiz ediyoruz.',
    ...
    },
    {
      ...
      title: 'Özel Sunum',
      description:
        'Sektörünüze ve kullanım senaryonuza özel hazırlanmış bir demoyu adım adım sunuyoruz.',
    ...
    },
    {
      ...
      title: 'Teknik Uyum',
      description:
        'Teknik ekibimiz entegrasyon ihtiyaçlarını, veri aktarımı ve sistem mimarisi detaylarını inceler.',
    ...
    },
    {
      ...
      title: 'Canlı Test',
      description:
        'Gerçek verilerinizle, güvenli bir demo ortamında sistemi bizzat deneyimleyin.',
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ERP sistemine geçiş sürecinizin sorunsuz, verimli ve hedeflerinize tam
            uyumlu olması için yapılandırılmış bir yaklaşım.
          </p>
        </div>
